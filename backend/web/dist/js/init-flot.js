// Dependency
// jquery.flot.selection.js & jquery.flot.time.js
var data7_1 = [
    [1354586000000, 153],
    [1354587000000, 365],
    [1354588000000, 398],
...
$(function() {
    var data = [
        { label: "Paid Signup", data: 60 },
        { label: "Free Signup", data: 30 },
        { label: "Guest Signup", data: 10 }
    ];
    var options = {
        series: {
            pie: {
...
$(function() {
    ...
    $.plot($("#pie-chart-donut"), data, options);
});
...
$(function() {
    ...
    var plot = $.plot($("#combine-chart"), data, options);
});
